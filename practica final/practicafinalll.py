...
class CajeroAutomatico:
    ...
    def validar_usuario(self, numero_cuenta, contraseña):
        for cliente in self.clientes:
            if cliente.numero_cuenta == numero_cuenta and contraseña == "1234":  
                return True
        return False
    ...
    def pagar_factura(self, numero_cuenta, contraseña, info_factura):
        for cliente in self.clientes:
            if cliente.numero_cuenta == numero_cuenta and contraseña == "12344":  
...
# Usuarios
cliente1 = Cliente("manuel", "villa de los almasigos 2000", "123456", 10000)
cliente2 = Cliente("ramon", "manuel bueno", "23456", 20000)
...
if cajero_automatico.validar_usuario(numero_cuenta, contraseña):
    print("Usuario autenticado como ramon.")
    # Solicitar 
